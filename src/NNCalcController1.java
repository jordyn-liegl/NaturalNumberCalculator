...
public final class NNCalcController1 implements NNCalcController {
    ...
    private static void updateViewToMatchModel(NNCalcModel model,
        ...
        /*
         * Call the updating buttons methods from the View1 constructor to see
         * whether or not the buttons should be enabled or disabled.
         */
        ...
        /*
         * Update the top and bottom text displays
         */
    ...
    public void processDivideEvent() {
         ...
         * Update model in response to this event
         */
        NaturalNumber topTemp = new NaturalNumber2();
        topTemp.transferFrom(top);
        top = topTemp.divide(bottom);
